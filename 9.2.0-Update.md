...
If your system version is above 9.2.0 but you have a low browser version (Such as 9.5.0-15U), you can also follow this guide. You will need to copy the contents of the [starter kit](https://smealum.github.io/ninjhax2/starter.zip) to your SD card, then substitute the sysUpdater CIA step to install [the Homebrew Launcher CIA](https://github.com/yellows8/hblauncher_loader/releases) instead, which you can then use to launch [this](https://mega.nz/#!10FjBKrB!PqbqJ8oSzoX-6iuhafR7kdHiWUBQSptrhjYTR6BLLUI) version of sysUpdater copied to the `/3ds/` folder on your SD card
