...
28. Open the sysUpdater application and press the A button to update if you are below 9.2.0, or the Y button to downgrade if you are above 9.2.0 with a low browser version (such as 9.4.0-15; the -15 indicates browser version which is not updated when a cart update is used)
