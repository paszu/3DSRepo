...
If you are below version 9.0.0, you can find instructions for updating or downgrading to 9.2.0-20 [here](https://github.com/Plailect/Guide/wiki/9.2.0-Update). Browserhax does not support versions below 9.0.0.
