...
14. If you get a black screen after downgrading, boot with the SD card removed; when you have booted, put the SD card back in, change your theme to anything else, then change it back to remove the old menuhax version
