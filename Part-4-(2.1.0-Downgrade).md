...
11. Open Decrypt9 **(This can sometimes take a few tries)**, then go to "Miscellaneous... (EmuNAND)", then select the "Health & Safety Dump" option to dump Health & Safety to `hs.app` **(you can use Up and Down / Left and Right to change the name)**
