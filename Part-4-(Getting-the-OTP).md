...
* The latest release of [OTPHelper](https://github.com/d0k3/OTPHelper/releases/tag/v0.5) (v0.6 is bugged)
...
9. Delete `emuNAND_original.bin` and `sysNAND_originaloriginal.bin` from your SD card
