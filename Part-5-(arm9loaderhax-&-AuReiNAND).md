...
13. Launch MiniPasta, which will patch your SysNAND and reboot you into the home menu *(if you use menuhax, you should hold your menuhax key while launching to reboot directly into SysNAND home menu)*
